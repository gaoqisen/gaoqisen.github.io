import{_ as n,X as s,Y as a,Z as e}from"./framework-6b2b1681.js";const p={},t=e(`<h2 id="一、优势" tabindex="-1"><a class="header-anchor" href="#一、优势" aria-hidden="true">#</a> 一、优势</h2><p>启动服务器后或者第一次执行后(可以设置)就可以把存储过程加载到高速缓存中,这样以后调用起来就不用再通过编译，执行效率当然就高。另外执行存储过程只需要传递几个参数，用语句就需要传递整个sql语句，有效减少网络数据的传递.</p><h2 id="二、存储过程" tabindex="-1"><a class="header-anchor" href="#二、存储过程" aria-hidden="true">#</a> 二、存储过程</h2><div class="language-sql line-numbers-mode" data-ext="sql"><pre class="language-sql"><code><span class="token comment">-- 创建测试表</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="四、springboot调用存储过程" tabindex="-1"><a class="header-anchor" href="#四、springboot调用存储过程" aria-hidden="true">#</a> 四、springBoot调用存储过程</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>@Query(value = &quot;call test(?1) &quot;, nativeQuery = true)
int selectdByLike(@Param(&quot;pname&quot;) String pname);
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div>`,11),o=[t];function c(l,i){return s(),a("div",null,o)}const r=n(p,[["render",c],["__file","msqlStoredProcedure.html.vue"]]);export{r as default};
