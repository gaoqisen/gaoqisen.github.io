import{_ as i,X as c,Y as l,a0 as n,a1 as s,$ as e,Z as t,G as o}from"./framework-6b2b1681.js";const p={},u=n("h1",{id:"docker安装",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#docker安装","aria-hidden":"true"},"#"),s(" docker安装")],-1),d={id:"一、elasticsearch",tabindex:"-1"},r=n("a",{class:"header-anchor",href:"#一、elasticsearch","aria-hidden":"true"},"#",-1),v={href:"https://es.xiaoleilu.com/010_Intro/15_API.html",target:"_blank",rel:"noopener noreferrer"},m=n("h3",{id:"_1-1-简介",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-1-简介","aria-hidden":"true"},"#"),s(" 1.1 简介")],-1),k={href:"https://www.docker.elastic.co/",target:"_blank",rel:"noopener noreferrer"},b=t(`<h3 id="_1-2-安装-lastic-需要-java-8-环境" tabindex="-1"><a class="header-anchor" href="#_1-2-安装-lastic-需要-java-8-环境" aria-hidden="true">#</a> 1.2 安装（lastic 需要 Java 8 环境）</h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">mac</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="二、常用语法" tabindex="-1"><a class="header-anchor" href="#二、常用语法" aria-hidden="true">#</a> 二、常用语法</h2><h3 id="_2-1-基本操作" tabindex="-1"><a class="header-anchor" href="#_2-1-基本操作" aria-hidden="true">#</a> 2.1 基本操作</h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token comment"># &lt;REST Verb&gt; http://localhost:9200/&lt;Index&gt;/&lt;Type&gt;/&lt;ID&gt;</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="二、kibana" tabindex="-1"><a class="header-anchor" href="#二、kibana" aria-hidden="true">#</a> 二、Kibana</h2><h3 id="_2-1-简介" tabindex="-1"><a class="header-anchor" href="#_2-1-简介" aria-hidden="true">#</a> 2.1 简介</h3><p>Kibana 是一款开源的数据分析和可视化平台，它是Elastic Stack 成员之一，设计用于和Elasticsearch 协作。 ... 它很简单，基于浏览器的界面便于您快速创建和分享动态数据仪表板来追踪Elasticsearch 的实时数据变化。 搭建Kibana 非常简单。</p><h3 id="_2-2-安装" tabindex="-1"><a class="header-anchor" href="#_2-2-安装" aria-hidden="true">#</a> 2.2 安装</h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">mac</span><span class="token punctuation">:</span> 
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-3-配置文件" tabindex="-1"><a class="header-anchor" href="#_2-3-配置文件" aria-hidden="true">#</a> 2.3 配置文件</h3>`,15),h={href:"https://www.elastic.co/guide/cn/kibana/current/settings.html",target:"_blank",rel:"noopener noreferrer"},g=t(`<h2 id="三、logstash" tabindex="-1"><a class="header-anchor" href="#三、logstash" aria-hidden="true">#</a> 三、Logstash</h2><h3 id="_3-1-简介" tabindex="-1"><a class="header-anchor" href="#_3-1-简介" aria-hidden="true">#</a> 3.1 简介</h3><p>它一个有jruby语言编写的运行在java虚拟机上的具有收集 分析转发数据流功能的工具</p><h3 id="_3-2-安装" tabindex="-1"><a class="header-anchor" href="#_3-2-安装" aria-hidden="true">#</a> 3.2 安装</h3><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">mac</span><span class="token punctuation">:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>Starting elasticsearch (via systemctl): [ 确定 ] // 出现这个表示启动成功</p></blockquote><h3 id="_1-3-配置" tabindex="-1"><a class="header-anchor" href="#_1-3-配置" aria-hidden="true">#</a> 1.3 配置</h3>`,18),q={href:"https://www.elastic.co/cn/downloads/elasticsearch",target:"_blank",rel:"noopener noreferrer"},y=t(`<li><p>修改config/elasticsearch.yml配置</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token comment"># 集群名称</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li><li><p>验证:，浏览器访问http://ip:9200输入帐号密码后返回json串表示启动成功。</p></li>`,3),_=t(`<h3 id="_1-4-安装遇到的问题" tabindex="-1"><a class="header-anchor" href="#_1-4-安装遇到的问题" aria-hidden="true">#</a> 1.4 安装遇到的问题</h3><h4 id="_1-2-1-外网无法访问" tabindex="-1"><a class="header-anchor" href="#_1-2-1-外网无法访问" aria-hidden="true">#</a> 1.2.1 外网无法访问</h4><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>vim config/elasticsearch.yml
// 增加下面配置
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,17);function x(f,E){const a=o("ExternalLinkIcon");return c(),l("div",null,[u,n("h2",d,[r,s(" 一、"),n("a",v,[s("Elasticsearch"),e(a)])]),m,n("p",null,[s("ElasticSearch是一个基于Lucene构建的开源，分布式，RESTful搜索引擎。 设计用于云计算中，能够达到实时搜索，稳定，可靠，快速，安装使用方便。官方维护的docker镜像"),n("a",k,[s("https://www.docker.elastic.co/"),e(a)])]),b,n("p",null,[n("a",h,[s("https://www.elastic.co/guide/cn/kibana/current/settings.html"),e(a)])]),g,n("ul",null,[n("li",null,[n("p",null,[s("下载安装包地址: "),n("a",q,[s("https://www.elastic.co/cn/downloads/elasticsearch"),e(a)])])]),y]),_])}const T=i(p,[["render",x],["__file","elk.html.vue"]]);export{T as default};
